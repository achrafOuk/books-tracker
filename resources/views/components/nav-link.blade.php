...
$classes = ($active ?? false)
            ? 'inline-flex items-center b px-1 pt-1 text-sm font-medium leading-5 text-purple border-b-2 border-purple hover:border-b-2  transition duration-150 ease-in-out focus:outline-none'
